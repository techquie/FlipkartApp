...
class WalletsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wallet" do
    assert_difference('Wallet.count') do
      post wallets_url, params: { wallet: { amount: @wallet.amount, customer_id: @wallet.customer_id, pin: @wallet.pin } }
    end
  ...
  test "should update wallet" do
    patch wallet_url(@wallet), params: { wallet: { amount: @wallet.amount, customer_id: @wallet.customer_id, pin: @wallet.pin } }

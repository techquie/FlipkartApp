...
class SellersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create seller" do
    assert_difference('Seller.count') do
      post sellers_url, params: { seller: { email: @seller.email, name: @seller.name, password: @seller.password } }
    end
  ...
  test "should update seller" do
    patch seller_url(@seller), params: { seller: { email: @seller.email, name: @seller.name, password: @seller.password } }
